...
/* appearance */
#include "/home/ipf/.suckless/dwm/theme.h"
...
static const char *fonts[]          = { "Noto Sans Mono:style=Medium:pixelsize=11:antialias=true:autohint=true" };
static const char dmenufont[]       = "Hack:style=Regula:size=10";
